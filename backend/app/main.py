...
async def lifespan(app: FastAPI):
    try:
        ...
        print("⚠️  Make sure DATABASE_URL is set in .env file")
        print("⚠️  Backend will continue but database features may not work")
    
    try:
        load_models()
    except Exception as e:
        print(f"⚠️  Model loading warning: {e}")
        print("⚠️  Backend will continue but predictions may use fallback formulas")
    
    try:
        load_all_data()
    except Exception as e:
        print(f"⚠️  Data loading warning: {e}")
        print("⚠️  Backend will continue but some features may not work")
    
    try:
        load_training_data()
    except Exception as e:
        print(f"⚠️  Training data loading warning: {e}")
        print("⚠️  Backend will continue")
