...
export default function History() {
  ...
  return (
    <div className="fixed inset-0 w-full h-full theme-bg-primary overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full overflow-y-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-20 md:pt-24 pb-8 md:pb-12 lg:pb-16 xl:pb-20">
        {selectedSimulation ? (
          <SimulationDetail
